...
void SimpleShapeApplication::init() {
    ...
    //Resizng
        ...
        P_ = projection;
        glm::mat4 camera  = glm::lookAt(glm::vec3(10.6, -20.0, 6.6), glm::vec3(-0.5, 0.1, 0.0), glm::vec3(0.0, 0.3, -0.25));
        V_= camera;

        glGenBuffers(1, &u_pvm_buffer_);
        glBindBuffer(GL_UNIFORM_BUFFER, u_pvm_buffer_);
        glBufferData(GL_UNIFORM_BUFFER, sizeof(glm::mat4), &P_, GL_STATIC_DRAW);
   ...
   void SimpleShapeApplication::framebuffer_resize_callback(int w, int h) {
    ...
    V_ = glm::lookAt(glm::vec3(10.6, -20.0, 6.6), glm::vec3(-0.5, 0.1, 0.0), glm::vec3(0.0, 0.3, -0.25));
